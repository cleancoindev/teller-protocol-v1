...
import "./IMarketsState.sol";
import "./IInterestValidator.sol";
import "./IEscrowFactory.sol";
import "./ILogicVersionsRegistry.sol";
...
interface ISettings {
    ...
    function versionsRegistry() external view returns (ILogicVersionsRegistry);

    function marketsState() external view returns (IMarketsState);

    function interestValidator() external view returns (IInterestValidator);
