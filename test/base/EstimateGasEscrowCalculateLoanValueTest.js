...
contract("EstimateGasEscrowCalculateTotalValueTest", function(accounts) {
  ...
  withData({
    ...
    _13_4_tokens_with_collateral_ratio_token: [ [ 1000, 2000, 3000, 4000 ], 300, 20, false],
    _14_5_tokens_with_collateral_ratio_token: [ [ 1000, 2000, 3000, 4000, 5000 ], 300, 20, false],
    _15_6_tokens_with_collateral_ratio_token: [ [ 1000, 2000, 3000, 4000, 5000, 6000 ], 300, 20, false],
    _16_7_tokens_with_collateral_ratio_token: [ [ 1000, 2000, 3000, 4000, 5000, 6000, 7000 ], 300, 20, false],
    _17_8_tokens_with_collateral_ratio_token: [ [ 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000 ], 300, 20, false],
    _18_9_tokens_with_collateral_ratio_token: [ [ 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000 ], 300, 20, false],
    _19_10_tokens_with_collateral_ratio_token: [ [ 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000 ], 300, 20, false],
  }, function(
    tokenAmounts,
    collateralAmount,
    collateralRatio,
